...
## Can use thresholds for the random forest as well

# Assuming logreg is the trained Logistic Regression model -- EXAMPLE -- Use threshold to sacrifice precision for Recall, Breadth search, gets better realistic results and accounts for unbalanced dataset
